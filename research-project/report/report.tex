...
We consider the case of single-person videos for now. In this setting, we distinguish two types of tasks: estimating the spatial coordinates of the skeleton and \ac{hmr}, which aims at superimposing a 3D body model correctly in space.
% \paragraph{a}
